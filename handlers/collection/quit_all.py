...
class QuitAllCollectionHandler(BaseHandler):
    ...
    def post(self):
        ...
        if self.session.get('session_role') == 'client':
            ...
            del keys_page_list, aux_all_keys, all_keys, aux, aux3, offset, comics,\
                lang, aux2, all_comics, all_comics_user  # Delete variables to free memory
