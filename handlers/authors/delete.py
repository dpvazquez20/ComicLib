...
from models.db import Author, User, ComicBook_Author, ComicBook


""" Delete handler in the authors home page
    Get: redirect to the authors home page 
    Post: it's responsible for deleting an author from the database"""
class DeleteAuthorHandler(BaseHandler):
