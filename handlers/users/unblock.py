...
""" Unblock handler in the users home page
    Get: redirect to the users home page 
    Post: it's responsible for unblocking the user in the database"""
class UnblockUserHandler(BaseHandler):
    ...
    def post(self):
        ...
        if self.session.get('session_role') == 'admin':
            ...
            if user and user is not None:
                ...
                if aux2 is not None:
                    # Variables to be sent to the HTML page
                    values["ok_message"] = lang["user_unblocked_successfully"]    # Ok message (User unblocked successfully)
                ...
                # Else show an error message
                    ...
                    # Variables to be sent to the HTML page
                    values["error_message"] = lang["error_unblock"]  # Error message (The unblock couldn't be done)
            ...
            # Else show an error message
                ...
                values["error_message"] = lang["user_not_unblocked"]   # Error message (User couldn't be unblocked)
