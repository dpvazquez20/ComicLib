        ...
        if self.session.get('session_role') == 'client':
            ...
            if search != "" and len(search) > 0:
                ...
                if comic and comic is not None:
                    ...
                    comics = self.get_comics_read_and_without_shelving(comics)  # Get only the comics without a shelving
